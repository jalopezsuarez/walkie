...
<body data-api="<?= htmlspecialchars($apiBase, ENT_QUOTES) ?>">
    ...
    <script src="assets/js/qr.js?v=12"></script>
    <script src="assets/js/audio.js?v=12"></script>
    <script src="assets/js/features/auth.js?v=12"></script>
    <script src="assets/js/features/contacts.js?v=12"></script>
    <script src="assets/js/features/conversation.js?v=12"></script>
    <script src="assets/js/features/pairing.js?v=12"></script>
    <script src="assets/js/features/settings.js?v=12"></script>
