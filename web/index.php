...
<body data-api="<?= htmlspecialchars($apiBase, ENT_QUOTES) ?>">
    ...
    <script src="assets/js/qr.js?v=8"></script>
    <script src="assets/js/audio.js?v=8"></script>
    <script src="assets/js/features/auth.js?v=8"></script>
    <script src="assets/js/features/contacts.js?v=8"></script>
    <script src="assets/js/features/conversation.js?v=8"></script>
    <script src="assets/js/features/pairing.js?v=8"></script>
    <script src="assets/js/features/settings.js?v=8"></script>
